...
tsforecast is a TypeScript project for ml utilities. It focuses on this technical goal: Build seasonal trend and residual forecast checks.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 157, risk penalty 7, latency penalty 4, and weight bonus 3. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
