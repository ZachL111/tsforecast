"""Regression checks for the tsforecast casebook."""
...
from casebook.harness import assert_expected, tsforecast_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(tsforecast_summary(), assert_expected())
