...
`tsforecast` is centered on ml utilities work in TypeScript. The technical target is: Build seasonal trend and residual forecast checks.
...
The score is deterministic. The current threshold is 157. Risk has a penalty of 7, latency has a penalty of 4, and weight contributes a bonus of 3.
